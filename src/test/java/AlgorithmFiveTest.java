...
public class AlgorithmFiveTest {
    ...
    public void azimuthAtZeroUT() throws Exception {
        assertEquals(-2.75173, algorithm.getAzimuth(), delta);
    }

    @Test
    public void rightAscensionAtZeroUT() throws Exception {
        assertEquals(5.3545, algorithm.getRightAscension(), delta);
    }

    @Test
    public void declinationAtZeroUT() throws Exception {
        assertEquals(-0.334134, algorithm.getDeclination(), delta);
    }

    @Test
    public void hourAngleAtZeroUT() throws Exception {
        assertEquals(-9.25957, algorithm.getHourAngle(), delta);
    }
