...
public class AlgorithmFourTest {
    ...
    public void zenithAtZeroUT() throws Exception {
        assertEquals(2.7205, algorithm.getZenith(), delta);
    }

    @Test
    public void azimuthAtZeroUT() throws Exception {
        assertEquals(-2.75164, algorithm.getAzimuth(), delta);
    }

    @Test
    public void rightAscensionAtZeroUT() throws Exception {
        assertEquals(5.35447, algorithm.getRightAscension(), delta);
    }

    @Test
    public void declinationAtZeroUT() throws Exception {
        assertEquals(-0.334142, algorithm.getDeclination(), delta);
    }

    @Test
    public void hourAngleAtZeroUT() throws Exception {
        assertEquals(-9.25954, algorithm.getHourAngle(), delta);
    }
